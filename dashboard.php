  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 col-lg-2 sidebar ">
      <ul class="nav nav-sidebar list-group-flush">
        <li class="list-group-item" style="width: 100%"><a href="#">Administracion<span class="sr-only">(current)</span></a></li>
        <li class="list-group-item" style="width: 100%"><a href="#">Personal</a></li>
        <li class="list-group-item" style="width: 100%"><a href="#">Proyectos</a></li>

        <li class="list-group-item" style="width: 100%"><a href="#">Personal2</a></li>
        <li class="list-group-item" style="width: 100%"><a href="#">Proyectos2</a></li>
        <li class="list-group-item" style="width: 100%"><a href="#">Personal3</a></li>
        <li class="list-group-item" style="width: 100%"><a href="#">Proyectos3</a></li>
      </ul>
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row placeholders">
          <div class="col-sm-8 col-md-6 col-lg-3 placeholder">
            <a href="#">
            <img src="img/diseno.jpeg" width="290" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
            </a>
            <h4>Diseño</h4>
            <!-- <span class="text-muted"></span> -->
          </div>
          <div class="col-sm-8 col-md-6 col-lg-3 placeholder">
            <img src="img/inventario.jpg" width="290" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
            <h4>Inventario</h4>
            <!-- <span class="text-muted">Detalles</span> -->
          </div>
          <div class="col-sm-8 col-md-6 col-lg-3 placeholder">
            <img src="img/manoObra.jpeg" width="290" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
            <h4>Producción</h4>
            <!-- <span class="text-muted">Detalles</span> -->
          </div>
          <div class="col-sm-8 col-md-6 col-lg-3 placeholder">
            <a href="ventas.php">
            <img src="img/ventas.jpeg" width="270" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
            </a>
            <h4>Ventas</h4>
