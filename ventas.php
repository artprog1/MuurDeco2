...
<h2 class="sub-header"><br>Proyección de Ventas</h2>
         ...
         <td>
           ...
           <?php
               while ($rowCliente=mysqli_fetch_assoc($resultClientes)) {
                 ...
                 $aPaternoCliente = $rowCliente['aPaternoCliente'];
                 $aMaternoCliente = $rowCliente['aMaternoCliente'];
                 $direccionCalle = $rowCliente['direccionCalle'];
                 $direccionCiudad = $rowCliente['direccionCiudad'];
                 $direccionEstado =  $rowCliente['direccionEstado'];
                 $direccionCodigoP =  $rowCliente['direccionCodigoP'];
                 $telefonoCliente = $rowCliente['telefonoCliente'];
             ?>
             <tr>
               <td><?php echo $idCliente ?></td>
               <td><?php echo $nombreCliente ?></td>
               <td><?php echo $aPaternoCliente ?></td>
               <td><?php echo $aMaternoCliente ?></td>
               <td><?php echo $direccionCalle ?></td>
               <td><?php echo $direccionCiudad ?></td>
               <td><?php echo $direccionEstado ?></td>
               <td><?php echo $direccionCodigoP ?></td>
