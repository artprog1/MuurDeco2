...
?>
            ...
            <div class="modalss" id="id40" style="">
              <div id="id40" class="modal-dialog modal-dialog-centered modal-xl" style="">
                <form class="modal-content animate" id="signupform" action="updateCliente.php?ID=<?php echo $idCliente; ?>" method="post" style="padding: 12px 20px; margin: 8px 0;">
                  ...
                  <h1>Registro de Cliente</h1>
                      <div class="form-row">
                         ...
                         <div class="form-group col-md-4 col-sm-6">
                           ...
                           <input type="text"  value="<?php echo $aPaternoCliente ?>" class="form-control" name="paterno" placeholder=" A. Paterno " id="primernombre" />
                         </div>
                         <div class="form-group col-md-4 col-sm-6">
                           <label for="materno">Apellido Materno</label>
                           <input type="text"  value="<?php echo $aMaternoCliente ?>" class="form-control" name="materno" placeholder=" A. Materno " id="primernombre" />
                         </div>
                       </div>
                       <div class="form-row">
                         <div class="form-group col-sm-6 col-md-6">
                           <label for="direccionCalle">Dirección de Calle</label>
                           <input type="text"  value="<?php echo $direccionCalle ?>" class="form-control" name="direccionCalle" placeholder="123 Calle" id="none" />
                         </div>
                         <div class="form-group col-sm-6 col-md-6">
                           <label for="ciudad">Ciudad</label>
                           <input type="text"  value="<?php echo $direccionCiudad ?>" class="form-control" name="ciudad" placeholder="Ej. Guadalajara" id="none" />
                         </div>
                         <div class="form-group col-md-6 col-sm-6">
                           <label for="estado">Estado</label>
                           <input type="text"  value="<?php echo $direccionEstado ?>" class="form-control" name="estado" placeholder="Ej. Jalisco" id="telefono" />
                         </div>

                         <!-- GENERAR EL QUERY DE LOS DEPTS -->
                         <div class="form-group col-sm-6 col-md-6">
                           <label for="postal">Codigo Postal</label>
                           <input type="text"  value="<?php echo $direccionCodigoP ?>" class="form-control" name="postal" placeholder="45000" id="" />
                       ...
                       <div class="form-row">
                         <div class="form-group col-sm-6 col-md-6">
                          ...
                          <input type="text" value="<?php echo $telefonoCliente ?>" class="form-control" name="telefono" placeholder="(33) 1234 5678" id="" />
                          </div>
                        </div>
                      <div class="alert">
                        <?php
