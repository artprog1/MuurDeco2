...
?>
            ...
            <div class="modalss" id="id40" style="">
              <div id="id40" class="modal-dialog modal-dialog-centered modal-xl" style="">
                ...
                <form class="modal-content animate" id="signupform" action="updateProyectoDeProduccion.php?ID=<?php echo $idProyecto; ?>" method="post" style="padding: 12px 20px; margin: 8px 0;">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-md-3">
                       ...
                       <select  class="custom-select" name="statusProyecto">
                         ...
                         <?php
                            $sqlm = mysqli_query($conn, "SELECT * FROM tblFlujo WHERE Secuencia = 4 OR Secuencia = 5");
